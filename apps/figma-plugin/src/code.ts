...
function getPngSize(bytes: Uint8Array): { width: number; height: number } | undefined {
...
function getJpegSize(bytes: Uint8Array): { width: number; height: number } | undefined {
...
function getWebpSize(bytes: Uint8Array): { width: number; height: number } | undefined {
...
function getImageSize(bytes: Uint8Array, fallbackWidth?: number, fallbackHeight?: number): { width: number; height: number } {
