    ...
    colorPalettes: [
      {
        ...
        prompt: "大面积彩色区域优先使用品牌蓝和紫色；清透天蓝用于局部高光和点缀；浅色底板、留白和高光保持干净通透，整体高级、冷静、科技感强。",
        enabled: true,
        createdAt: timestamp,
        updatedAt: timestamp,
      },
      {
        ...
        prompt: "大面积彩色区域优先使用可信蓝和清新绿；极浅白灰用于底板、留白、浅色部件和高光，整体干净、稳定、金融产品感。",
        enabled: true,
        createdAt: timestamp,
        updatedAt: timestamp,
      },
      {
        ...
        prompt: "大面积彩色区域使用柠檬黄、浅粉、橙黄等柔和暖色；浅色底板和留白保持干净，颜色在材质内部自然融合，有轻微软糖感。",
        enabled: true,
        createdAt: timestamp,
        updatedAt: timestamp,
      },
