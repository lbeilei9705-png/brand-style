    ...
    colorPalettes: [
      {
        ...
        prompt: "配色以品牌蓝和紫色为主，辅以清透天蓝高光，整体高级、冷静、科技感强。",
        enabled: true,
        createdAt: timestamp,
        updatedAt: timestamp,
      },
      {
        ...
        prompt: "配色以可信蓝、清新绿和极浅白灰为主，整体干净、稳定、金融产品感。",
        enabled: true,
        createdAt: timestamp,
        updatedAt: timestamp,
      },
      {
        ...
        prompt: "配色使用柠檬黄、浅粉、橙黄等柔和暖色，颜色在材质内部自然融合，有轻微软糖感。",
        enabled: true,
        createdAt: timestamp,
        updatedAt: timestamp,
      },
    ...
    shapeArchitectures: [
      {
        ...
        prompt: "形体架构以原图为准，严格保留主体轮廓、元素相对位置、图形数量、视觉层级和整体构图，只做材质、体积、光影或风格转译。",
        enabled: true,
        createdAt: timestamp,
        updatedAt: timestamp,
      },
      {
        ...
        prompt: "形体架构采用圆润体块结构，把平面图形转译为厚实、饱满、边缘圆滑的 3D 块面，保持识别特征清楚，不增加无关元素。",
        enabled: true,
        createdAt: timestamp,
        updatedAt: timestamp,
      },
      {
        ...
        prompt: "形体架构采用层叠贴片结构，将元素拆分为清晰的多层贴片、叠片或卡片化部件，边缘有厚度，层级关系明确，整体仍保持原图语义。",
        enabled: true,
        createdAt: timestamp,
        updatedAt: timestamp,
      },
      {
        ...
        prompt: "形体架构采用软体鼓包结构，主体具有柔软膨胀感、自然圆角、轻微挤压、压痕和回弹体积，适合软包、充气、泡棉或织物材质。",
        enabled: true,
        createdAt: timestamp,
        updatedAt: timestamp,
      },
      {
        ...
        prompt: "形体架构采用模块化几何结构，用清晰的几何部件、秩序化分块和稳定比例重组图形，轮廓干净，结构理性，不改变核心识别语义。",
        enabled: true,
        createdAt: timestamp,
        updatedAt: timestamp,
      },
...
export class ConfigStore {
  ...
  upsertAgent(agent: Partial<AgentConfig> & Pick<AgentConfig, "name" | "description" | "systemPrompt" | "defaultStylePresetId">): AgentConfig {
    ...
    const next: AgentConfig = {
      ...
      driverModelId: agent.driverModelId || existing?.driverModelId || "mock-preview",
      enabled: agent.enabled ?? true,
      createdAt: existing?.createdAt || timestamp,
      updatedAt: timestamp,
    };
